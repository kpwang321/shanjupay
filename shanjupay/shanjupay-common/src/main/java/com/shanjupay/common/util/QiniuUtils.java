...
//...其他参数参考类注释
        UploadManager uploadManager = new UploadManager(cfg);
//...生成上传凭证，然后准备上传
        String accessKey = "N4j146KMOEPhVgYKxqjioSbQhkciYiGQzdHPsdk9";
        String secretKey = "2o4G6NqDU4QHsw7auuzZFPjuET7FnXCoWpHL-l-s";
        String bucket = "shanjupay-kpwang";
//默认不指定key的情况下，以文件内容的hash值作为文件名
        String key = UUID.randomUUID().toString()+".png";
        FileInputStream fileInputStream = null;
        try {

            String filePath = "F:\\BaiduNetdiskDownload\\03_聚善支付项目\\day04-商户资质申请 七牛云 异常处理\\图片\\2.jpg";
